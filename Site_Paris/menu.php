    ...
    <head>
        ...
        <?php
            ...
            switch(basename($_SERVER['PHP_SELF'])) {
                case "index.php" : $title = "Paris - Accueil"; break;
                case "geographie.php" : $title = "Paris - Géographie"; break;
                case "histoire.php" : $title = "Paris - Histoire"; break;
                case "culture.php" : $title = "Paris - Culture"; break;
                case "galerie.php" : $title = "Paris - Galerie"; break;
                case "contact.php" : $title = "Paris - Contact"; break;
                case "liens.php" : $title = "Paris - Liens"; break;
                default : $title = "Paris";
            }
